...
function App() {
  ...
  */
  ...
  return (
    ...
    <>
      {/* JSX-Kommentar */}
      Hallo, {vorname}!<h2>Conditional Rendering</h2>
      <h4>if-Logik</h4>
      {ausgabe1}
      <h4>if-else-Logik</h4>
      {ausgabe2}
      ...
      <h4>if-Logik</h4>
      {
        ...
        istAngemeldet && <div>Willkommen!</div>
      }
      <h4>if-else-Logik</h4>
      {
        /* if-else-Logik per ternärem Operator */
        istAngemeldet ? <div>Willkommen!</div> : <div>Bitte anmelden!</div>
      }
      <Properties vorname={vorname} nachname={nachname} bio={biografie} />
      <Listen />
    </>
  );
}
